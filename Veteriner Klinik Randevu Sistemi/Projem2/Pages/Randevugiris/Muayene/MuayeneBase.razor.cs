...
namespace Projem2.Pages.Randevugiris
{
    public class MuayeneBase : ComponentBase
    {
        public string Hastanin_Turu { get; set; }
        public string Hastanin_Cinsi { get; set; }
        public string Mikrocip_No { get; set; }
        public string Muayene_Nedeni { get; set; }
      ...
      public DateTime Randevu_Tarihi { get; set; } = new DateTime(2023, 1, 1);
        ...
        static string insertQuery = "INSERT INTO Muayene_Randevu_Table (Hastanın_Turu,Hastanin_Cinsi,Mikrocip_No,Muayene_Nedeni,Sahibinin_ismi,Sahibinin_Soyismi,Telefon_No,Randevu_Tarihi) VALUES (@Hastanin_Turu,@Hastanin_Cinsi, @Mikrocip_No, @Muayene_Nedeni, @Sahibinin_ismi, @Sahibinin_soyismi, @Telefon_No, @Randevu_Tarihi)";
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Muayene_Nedeni", Muayene_Nedeni);
